...
int main() {
  ...
  if (mode == 'N' || mode == 'n') {
    nn << convolutional_layer<leaky_relu>(19, 19, 5, 3, 16, padding::same)
       << convolutional_layer<leaky_relu>(19, 19, 3, 16, 16, padding::same)
       << convolutional_layer<leaky_relu>(19, 19, 3, 16, 16, padding::same)
       << convolutional_layer<leaky_relu>(19, 19, 3, 16, 16, padding::same)
       << convolutional_layer<leaky_relu>(19, 19, 3, 16, 16, padding::same)
       << convolutional_layer<leaky_relu>(19, 19, 3, 16, 16, padding::same)
       << convolutional_layer<leaky_relu>(19, 19, 3, 16, 16, padding::same)
       << convolutional_layer<leaky_relu>(19, 19, 3, 16, 16, padding::same)
       << convolutional_layer<softmax>(19, 19, 3, 16, 1, padding::same);
  } else {
    nn.load("nn");
