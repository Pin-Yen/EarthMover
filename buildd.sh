g++ -c -std=c++11 main.cpp -o main.o -g -DDEBUG
...
g++ -std=c++11 displayboard.o virtualboard.o point.o evaluator.o typetree.o gametree.o node.o objectcounter.o log.o main.o -o FiveInARowD -g -DDEBUG