g++ -c -std=c++11 main.cpp -o main.o -O3 -DTIME
...
g++ -std=c++11 displayboard.o virtualboard.o point.o evaluator.o typetree.o gametree.o node.o main.o -o FiveInARowT -DTIME -O3